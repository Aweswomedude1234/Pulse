...
#ifndef PULSE_WATCH_APP_SWIFT_H
#define PULSE_WATCH_APP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Pulse_Watch_App",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC15Pulse_Watch_App19WatchSessionManager")
...
@class WCSession;
@class NSString;
@interface WatchSessionManager (SWIFT_EXTENSION(Pulse_Watch_App)) <WCSessionDelegate>
