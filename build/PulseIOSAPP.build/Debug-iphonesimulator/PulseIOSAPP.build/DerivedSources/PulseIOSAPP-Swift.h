...
#ifndef PULSEIOSAPP_SWIFT_H
#define PULSEIOSAPP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="PulseIOSAPP",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class UIApplication;
SWIFT_CLASS("_TtC11PulseIOSAPP11AppDelegate")
...
SWIFT_CLASS("_TtC11PulseIOSAPP19NotificationManager")
...
SWIFT_CLASS("_TtC11PulseIOSAPP24WatchConnectivityManager")
@interface WatchConnectivityManager : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class WCSession;
@interface WatchConnectivityManager (SWIFT_EXTENSION(PulseIOSAPP)) <WCSessionDelegate>
